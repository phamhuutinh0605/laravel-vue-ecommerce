                        ...
                        <div x-data="productItem(product)">
                            <div class="w-full flex flex-col sm:flex-row items-center gap-4 flex-1">
                                <a :href="product.href"
                                    ...
                                    <img :src="product.image" class="object-contain w-100" alt="" />
                                </a>
                                    ...
                                    <div class="flex justify-between items-center">
                                        <div class="flex items-center">
                                            ...
                                            <input type="number" min="1" x-model="product.quantity"
                                                ...
                                                class="ml-3 py-1 border-gray-200 focus:border-cyan-600 focus:ring-cyan-600 w-16" />
                                        </div>
                                        <a href="#" @click.prevent="removeItemFromCart()"
                                            class="text-cyan-600 hover:text-cyan-500">Remove</a>
                                    </div>
                                </div>
                            </div>
                            <!--/ Product Item -->
