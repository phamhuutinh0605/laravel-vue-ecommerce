<header x-data="{
    ...
    <div>
        <a href="{{ route('home') }}" class="block my-4 pl-5">
            <img src="{{ asset('logo.png') }}" alt="" class="w-100 max-w-[120px]"> </a>
    </div>
    <!-- Responsive Menu -->
            ...
            @else
                ...
                <li class="px-3 py-3">
                    <a href="{{ route('register') }}"
                        class="block text-center text-white bg-cyan-600 py-2 px-3 rounded shadow-md hover:bg-cyan-700 active:bg-cyan-800 transition-colors w-full">
                        Register now
                    </a>
                </li>
            @endif
    ...
    <nav class="hidden md:block">
        <ul class="grid grid-flow-col items-center">
            ...
            @else
                ...
                <li>
                    <a href="{{ route('register') }}"
                        class="inline-flex items-center text-white bg-cyan-600 py-2 px-3 rounded shadow-md hover:bg-cyan-700 active:bg-cyan-800 transition-colors mx-5">
                        Register now
                    </a>
                </li>
            @endif
