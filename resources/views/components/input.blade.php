...
$defaultClasses = '';
$successClasses = 'border-slate-500 focus:border-slate-500 ring-1 ring-slate-500 focus:ring-slate-500';
...
<div>
    ...
    @if ($type === 'select')
        <select {{ $disabled ? 'disabled' : '' }} {!! $attributes->merge([
            'class' =>
                'border-gray-300 focus:border-cyan-500 focus:outline-none focus:ring-cyan-500 rounded-md w-full ' .
