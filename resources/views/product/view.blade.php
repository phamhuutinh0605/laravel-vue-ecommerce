    ...
    <div x-data="productItem({{ json_encode([
        ...
        <div class="grid gap-6 grid-cols-1 lg:grid-cols-5">
                    ...
                    <div class="relative">
                        <template x-for="image in images">
                            <div x-show="activeImage === image" class="aspect-w-3 aspect-h-2">
                                <img :src="image" alt=""
                                    class="w-100 max-w-[450px] object-contain mx-auto" />
                            </div>
                        </template>
                    ...
                    <div class="flex">
                        <template x-for="image in images">
                            <a @click.prevent="activeImage = image"
                                class="cursor-pointer w-[80px] h-[80px] border border-gray-300 hover:border-cyan-500 flex items-center justify-center"
            ...
            <div class="lg:col-span-2">
                ...
                <div class="text-xl font-bold my-6">Price: ${{ $product->price }}</div>
                <div class="flex items-center justify-between mb-5">
                    <label for="quantity" class="block font-bold mr-4">
                        Quantity
                    </label>
                    <input type="number" name="quantity" x-ref="quantityEl" value="1" min="1"
                        class="w-32 focus:border-cyan-500 focus:outline-none rounded" />
                </div>
                ...
                <div class="mb-6" x-data="{ expanded: false }">
                    ...
                    <p class="text-right">
                        <a @click="expanded = !expanded" href="javascript:void(0)"
                            class="text-cyan-500 hover:text-cyan-700" x-text="expanded ? 'Read Less' : 'Read More'"></a>
                    </p>
                </div>
            </div>
        </div>
