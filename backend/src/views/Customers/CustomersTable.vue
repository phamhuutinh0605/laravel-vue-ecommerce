<template>
  <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
    ...
    <table class="table-auto w-full">
      ...
      <tbody v-else>
        <tr v-for="(customer, index) of customers.data" :key="index">
          ...
          <td class="border-b p-2">
            <span
              ...
              class="text-white px-2 py-1 rounded-md bg-emerald-500"
            >
              {{ customer.status }}
            </span>
            <span v-else class="text-white px-2 py-1 rounded-md bg-slate-400">
              disabled
            </span>
          </td>
          <td class="border-b p-2">
